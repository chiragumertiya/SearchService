...
builder.Services.AddTransient<ISearchPersonService, SearchPersonService>();
builder.Services.AddSingleton<ILoggerManager, LoggerManager>();

builder.Services.AddDbContext<SearchServiceDbContext>(options => options.UseSqlServer(builder.Configuration.GetConnectionString("conStr_app_SearchService")));
